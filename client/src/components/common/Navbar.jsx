...
export default function Navbar({ onMenuClick }) {
  ...
  return (
    <header className="sticky top-0 z-10 bg-dark-800/80 backdrop-blur-xl border-b border-dark-600 px-4 md:px-6 h-16 flex items-center justify-between gap-4">
      {/* Left: menu + title */}
      ...
      <div className="flex items-center gap-2">
                ...
                {notifications.length === 0 ? (
                  ...
                  notifications.slice(0, 10).map((n) => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 hover:bg-dark-700 transition-colors border-b border-dark-700 ${!n.isRead ? 'bg-dark-700/50' : ''}`}
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-sm font-medium text-slate-200 line-clamp-1">{n.title}</p>
        ...
        <div className="relative" ref={profileRef}>
          <button
            ...
            className="flex items-center gap-2 pl-2 pr-3 py-1.5 rounded-xl hover:bg-dark-700 transition-colors"
          >
